...
(defmethod render ((widget html-framework-box) &key content)
              ...
              (:header 
               (:div :id "header_toolbar"
                     (:div :class "container_12"
                           ...
                           (:h1 :class "grid_8" (str "EMS (E-Marketing System)"))
                           "<!-- Start of right part -->"
                           (:div :class "grid_4"
                           ...
                           (:ul :id "nav_main"
                                (:li 
                                 ...
                                 (:ul
                                  ...
                                  (:li 
                                   (:a :href "/ems/quickstats" (str "Quick Stats")))
                                  (:li 
                                   (:a :href "/ems/index" (str "Login")))))
                                (:li 
                                 (:a :href "#"
                                 ...
                                 (:ul
                                  ...
                                  (:li 
                                   (:a :href "/ems/twitter-users" "Twitter Users"))
                                  (:li 
                                   (:a :href "/ems/facebook-users" "Facebook Users"))))))
                     )
