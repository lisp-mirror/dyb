...
(defmethod render ((widget peach-form) &key content grid)
  (with-html
  ...
  (with-html
    (:div :id "header_toolbar"
          (:div :class "container_12"
                ...
                (:h1 :class "grid_8" (str "Dig Your Brand - Tool for Brand Management."))
                ;; Start of right part
                (:div :class "grid_4"
  ...
  (let ((title (or (title widget) (name widget))))
    (with-html-string
      ...
      (:body :class  (slot-val widget 'body-class)
             ...
             (:script :defer t :src "/js/ems/ajax.js")
  ...
  (let ((page (make-widget 'bare-peach :name "peach-page"))
    ...
    (render page
            ...
            "<script defer src='/js/mylibs/jquery.ba-resize.js'></script>
             ...
             <script defer src='/js/mylibs/jquery.ui.timepicker.js'></script>")))
