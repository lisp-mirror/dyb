...
(defclass fb-post-comment-form (widget)
                   ...
                   (:div :class "widget-content" :style "background:white;"
                         (if (get-val doc 'from)
                             (htm
                              ...
                              (:div :id (format nil "comments-~A" (get-val doc 'post-id)) :style "background-color:#F2F2F2;display:none;"
                                    (:br)
                                    ...
                                    (:br)
                                    (let ((comment-form (make-instance 'fb-post-comment-form  :name (get-val doc 'post-id))))
